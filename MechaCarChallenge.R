...
> save.image("C:/Users/Mama Lincoln/Desktop/R_Analysis/rrrr.RData")
> View(mecha_car_mpg)
> ### Deliverable 1 ###
...
> ot_summary <- susp_coil %>% group_by(Manufacturing_Lot) %>% summarize(Mean = mean(PSI), Median = median(PSI),Variance = var(PSI), SD = sd(PSI))
...
> save.image("C:/Users/Mama Lincoln/Desktop/R_Analysis/MechaCarChallenge.R.RData")
> save.image("C:/Users/Mama Lincoln/Desktop/R_Analysis/MechaCarChallenge.R.RData")
> 